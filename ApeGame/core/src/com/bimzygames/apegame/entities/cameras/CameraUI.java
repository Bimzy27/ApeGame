...
public class CameraUI extends Entity implements ICamera
{
    ...
    public CameraUI(IComponent... components)
    {
        super(components);
        DIContainer.getInstance().register(CameraUI.class, this);
    }
    ...
    public void Deinitialize() {
        DIContainer.getInstance().unregister(CameraUI.class);
        super.Deinitialize();
    }
